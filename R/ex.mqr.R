...
#'
#' A population correlation matrix composed of 6 items from a two factor stucture. Factor 1 is based on items 1 to 4, and Factor 2 is based on items 4 to 6.
#' 
